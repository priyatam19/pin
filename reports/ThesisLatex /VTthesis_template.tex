...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.92\textwidth]{images/architecture_flow.png}
    \caption{End-to-end architecture showing how preprocessing, static analysis, code generation, and verification stages interact.}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{images/dual_parser_choice.png}
    \caption{Selector-driven dual parser workflow highlighting preprocessing differences and convergence into shared metadata.}
    \label{fig:dual_parser}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.82\textwidth]{images/input_identification_decision.png}
    \caption{Decision flow for prioritizing target functions, main signatures, and configuration globals when registering inputs.}
    \label{fig:input_identification}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.88\textwidth]{images/type_mapping_matrix.png}
    \caption{Matrix summarizing how C categories map into Protocol Buffer encodings and where pointer metadata is applied.}
    \label{fig:type_mapping_matrix}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{images/pointer_reconstruction_cheatsheet.png}
    \caption{Quick reference for how decoded message fields map to pointer reconstruction templates across helper types.}
    \label{fig:pointer_cheatsheet}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{images/emi_feedback_loop.png}
    \caption{Differential testing loop with EMI filter gating comparisons between normalized binaries and reference runners.}
    \label{fig:emi_loop}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.88\textwidth]{images/pointer_fixture_scorecard.png}
    \caption{Visual scorecard reinforcing the table by clustering pointer fixtures into pass, pending, and blocked buckets.}
    \label{fig:pointer_scorecard}
\end{figure}
