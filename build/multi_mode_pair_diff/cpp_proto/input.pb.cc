...
const uint32_t TableStruct_input_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Input, _impl_.primary_),
  PROTOBUF_FIELD_OFFSET(::Input, _impl_.secondary_),
};
...
const ::_pbi::DescriptorTable descriptor_table_input_2eproto = {
    false, false, 66, descriptor_table_protodef_input_2eproto,
    "input.proto",
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Input.primary"));
        } else
          goto handle_unusual;
        continue;
      // string secondary = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Input.secondary"));
        } else
          goto handle_unusual;
        continue;
      default:
