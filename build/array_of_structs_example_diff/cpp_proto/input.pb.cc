...
PROTOBUF_CONSTEXPR SamplePtr::SamplePtr(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.value_)*/nullptr
  , /*decltype(_impl_.present_)*/false
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct SamplePtrDefaultTypeInternal {
  PROTOBUF_CONSTEXPR SamplePtrDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~SamplePtrDefaultTypeInternal() {}
  union {
    SamplePtr _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 SamplePtrDefaultTypeInternal _SamplePtr_default_instance_;
PROTOBUF_CONSTEXPR Input::Input(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.samples_)*/nullptr
...
const uint32_t TableStruct_input_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::SamplePtr, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::SamplePtr, _impl_.present_),
  PROTOBUF_FIELD_OFFSET(::SamplePtr, _impl_.value_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Input, _impl_.samples_),
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Sample, _impl_.id_),
  PROTOBUF_FIELD_OFFSET(::Sample, _impl_.value_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::SamplePtr)},
  { 8, -1, -1, sizeof(::Input)},
  { 16, -1, -1, sizeof(::Sample)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::_SamplePtr_default_instance_._instance,
...
const char descriptor_table_protodef_input_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\013input.proto\"4\n\tSamplePtr\022\017\n\007present\030\001 "
  "\001(\010\022\026\n\005value\030\002 \001(\0132\007.Sample\"3\n\005Input\022\033\n\007"
  "samples\030\001 \001(\0132\n.SamplePtr\022\r\n\005count\030\002 \001(\005"
  "\"#\n\006Sample\022\n\n\002id\030\001 \001(\005\022\r\n\005value\030\002 \001(\002b\006p"
  "roto3"
  ;
static ::_pbi::once_flag descriptor_table_input_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_input_2eproto = {
    false, false, 165, descriptor_table_protodef_input_2eproto,
    "input.proto",
...
class SamplePtr::_Internal {
 public:
  static const ::Sample& value(const SamplePtr* msg);
};

const ::Sample&
SamplePtr::_Internal::value(const SamplePtr* msg) {
  return *msg->_impl_.value_;
}
SamplePtr::SamplePtr(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:SamplePtr)
}
SamplePtr::SamplePtr(const SamplePtr& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  SamplePtr* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.value_){nullptr}
  ...
  if (from._internal_has_value()) {
    _this->_impl_.value_ = new ::Sample(*from._impl_.value_);
  }
  _this->_impl_.present_ = from._impl_.present_;
  // @@protoc_insertion_point(copy_constructor:SamplePtr)
}

inline void SamplePtr::SharedCtor(
...
SamplePtr::~SamplePtr() {
  // @@protoc_insertion_point(destructor:SamplePtr)
...
inline void SamplePtr::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  if (this != internal_default_instance()) delete _impl_.value_;
}

void SamplePtr::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void SamplePtr::Clear() {
// @@protoc_insertion_point(message_clear_start:SamplePtr)
...
const char* SamplePtr::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
...
uint8_t* SamplePtr::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:SamplePtr)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:SamplePtr)
  return target;
}

size_t SamplePtr::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:SamplePtr)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData SamplePtr::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    SamplePtr::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*SamplePtr::GetClassData() const { return &_class_data_; }


void SamplePtr::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<SamplePtr*>(&to_msg);
  auto& from = static_cast<const SamplePtr&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:SamplePtr)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  if (from._internal_has_value()) {
    _this->_internal_mutable_value()->::Sample::MergeFrom(
...
void SamplePtr::CopyFrom(const SamplePtr& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:SamplePtr)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool SamplePtr::IsInitialized() const {
  return true;
}

void SamplePtr::InternalSwap(SamplePtr* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(SamplePtr, _impl_.present_)
      + sizeof(SamplePtr::_impl_.present_)
      - PROTOBUF_FIELD_OFFSET(SamplePtr, _impl_.value_)>(
          reinterpret_cast<char*>(&_impl_.value_),
          reinterpret_cast<char*>(&other->_impl_.value_));
}

::PROTOBUF_NAMESPACE_ID::Metadata SamplePtr::GetMetadata() const {
...
class Input::_Internal {
 public:
  static const ::SamplePtr& samples(const Input* msg);
};

const ::SamplePtr&
Input::_Internal::samples(const Input* msg) {
  return *msg->_impl_.samples_;
}
...
Input::Input(const Input& from)
  ...
  if (from._internal_has_samples()) {
    _this->_impl_.samples_ = new ::SamplePtr(*from._impl_.samples_);
  }
...
inline void Input::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  if (this != internal_default_instance()) delete _impl_.samples_;
}
...
uint8_t* Input::_InternalSerialize(
  ...
  // .SamplePtr samples = 1;
  if (this->_internal_has_samples()) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(1, _Internal::samples(this),
        _Internal::samples(this).GetCachedSize(), target, stream);
  }
...
void Input::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_has_samples()) {
    _this->_internal_mutable_samples()->::SamplePtr::MergeFrom(
...
template<> PROTOBUF_NOINLINE ::SamplePtr*
Arena::CreateMaybeMessage< ::SamplePtr >(Arena* arena) {
  return Arena::CreateMessageInternal< ::SamplePtr >(arena);
}
