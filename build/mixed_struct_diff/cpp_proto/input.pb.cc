...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_input_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Input, reading_),
  PROTOBUF_FIELD_OFFSET(::Input, flag0_),
  PROTOBUF_FIELD_OFFSET(::Input, flag1_),
  PROTOBUF_FIELD_OFFSET(::Input, flag2_),
  PROTOBUF_FIELD_OFFSET(::Input, note_),
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_input_2eproto = {
  false, false, descriptor_table_protodef_input_2eproto, "input.proto", 118,
...
Input::Input(const Input& from)
  ...
  ::memcpy(&reading_, &from.reading_,
    static_cast<size_t>(reinterpret_cast<char*>(&flag2_) -
    reinterpret_cast<char*>(&reading_)) + sizeof(flag2_));
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 17)) {
          reading_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else goto handle_unusual;
        continue;
      // int32 flag0 = 3;
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 24)) {
          flag0_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // int32 flag1 = 4;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 50)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "Input.note"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* Input::_InternalSerialize(
  ...
  // double reading = 2;
  if (!(this->reading() <= 0 && this->reading() >= 0)) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteDoubleToArray(2, this->_internal_reading(), target);
  }

  // int32 flag0 = 3;
  if (this->flag0() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(3, this->_internal_flag0(), target);
  }

  // int32 flag1 = 4;
  if (this->flag1() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(4, this->_internal_flag1(), target);
  }

  // int32 flag2 = 5;
  if (this->flag2() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(5, this->_internal_flag2(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:Input)
  ...
  if (!(from.reading() <= 0 && from.reading() >= 0)) {
  ...
  if (from.flag0() != 0) {
    _internal_set_flag0(from._internal_flag0());
  }
  if (from.flag1() != 0) {
...
void Input::InternalSwap(Input* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      - PROTOBUF_FIELD_OFFSET(Input, reading_)>(
          ...
          reinterpret_cast<char*>(&other->reading_));
}
