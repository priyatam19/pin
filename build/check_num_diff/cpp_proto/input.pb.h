...
inline ::PROTOBUF_NAMESPACE_ID::int32 Input::_internal_n() const {
  return n_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Input::n() const {
  // @@protoc_insertion_point(field_get:Input.N)
  return _internal_n();
}
inline void Input::_internal_set_n(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  n_ = value;
}
inline void Input::set_n(::PROTOBUF_NAMESPACE_ID::int32 value) {
