...
_INPUT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='sensor_id', full_name='Input.sensor_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='temperature', full_name='Input.temperature', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='mode', full_name='Input.mode', index=2,
